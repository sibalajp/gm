  ...
  render() {
    return(
      <div className="carousel-container" style={ style}>
          <div className="mainpic-content"><h1>In-home classic car wash as low as $17</h1>  </div>
          <div className="mainpic-content"><h2>We wash with passion, without the fancy gear</h2>  </div>
          <div className="mainpic-content form-group">
            <form onSubmit={this.checkZip} >
              <input className="zip-code" type="text" name="fname" placeholder="ZIPCODE" onChange={this.handleChange} ></input>
