      ...
      <div id="how_it_works" className=" howitworks-container">
        ...
        <div className="steps-content">
          ...
          <div className="hiw-sub-containers">
            ...
            <p>
              {" "}
              One of our partners will meet you at your house, equipped with the
              basics, and ready perform.
            </p>
            <div className="step-image-container">
          ...
          <div className="hiw-sub-containers">
            ...
            <p>
              When car wash is finished, tell us your thoughts. It helps us
              strive for quality service.
            </p>
            <div className="step-image-container">
